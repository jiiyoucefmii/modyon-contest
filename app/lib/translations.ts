...
export const translations: Record<string, Translations> = {
  EN: {
    ...
    contestForm: {
      ...
      clientTitle: "Client",
      clientDescription: "I want to buy clothing",
      creatorTitle: "Seller",
      creatorDescription: "Designer/Seller/Printer",
  ...
  AR: {
    ...
    hero: {
      ...
      description:
        "موديون هو سوق يجمع بائعي الملابس و المصممين و الطابعين مع أولئك الذين يحبون الإبداعات الفريدة، المصنوعة يدوياً والمخصصة.",
      joinNow: "انضم الآن",
    ...
    contestForm: {
      ...
      userTypeLabel: "أنا:",
      clientTitle: "مشتري",
      clientDescription: "أريد شراء ملابس ",
      creatorTitle: "بائع",
      creatorDescription: "مصمم/ بائع/ طابع تصاميم",
  ...
  FR: {
    ...
    contestForm: {
      ...
      clientTitle: "Client",
      clientDescription: "Je veux acheter des vêtements",
      creatorTitle: "Vendeur",
      creatorDescription: "Designer/Vendeur/Imprimeur",
